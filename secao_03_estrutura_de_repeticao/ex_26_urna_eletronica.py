...
def calcular_votos(*votos):
    ...
    print("Votantes:", votantes_qtd)
    print("Votos no candidato corrupto:", corrupto)
    print("Votos no candidato mentiroso:", mentiroso)
    print("Votos no candidato rouba, mas faz:", lula)
